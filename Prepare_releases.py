...
if __name__ == '__main__':
    ...
    if Wave_PostProcessingHpcSubmit.RUN_PREPARE_SUMMARY_RELEASE.lower() == 'yes':
        Wave_PostProcessingHpcSubmit.print_message("PREPARING A SUMMARY RELEASE FILE")
    ...
    if Wave_PostProcessingHpcSubmit.RUN_PREPARE_DAILY_RELEASE.lower() == 'yes':
        Wave_PostProcessingHpcSubmit.print_message("PREPARING A DAILY RELEASE FILE")
    ...
    if Wave_PostProcessingHpcSubmit.RUN_PREPARE_HOURLY_RELEASE.lower() == 'yes':
        Wave_PostProcessingHpcSubmit.print_message("PREPARING A HOURLY RELEASE FILE")
